# inject /reducr methids - derive a new value by combing ll array elemets

# first block varaivle - the "aggreate" value, the value being calculated
# second block variable - the current array eleemt
# block claculation - what to send to next loop as the "aggregate" value
